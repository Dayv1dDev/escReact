                ...
                <section className="flex w-[1000px] h-[400px]">
                    ...
                    <form method="POST" action="/register" className="flex flex-col justify-center w-full rounded-r-sm bg-black/50 p-10">
                        ...
                        <article className="flex flex-col gap-9 mb-4">
                            ...
                            <div className="relative">
                                <input ref={emailInputRef} onInput={handleEmailInput} className="relative w-full py-2 pr-2 pl-2 bg-transparent text-base font-medium border-none outline-0 z-20 transition-all duration-300" type="email" id='email' name='email' required />
                        ...
                        <button type="submit" className="w-fit self-center py-2 px-8 mt-4 font-semibold rounded-full bg-gradient-to-br from-emerald-600 to-blue-600 hover:scale-110 transition-all duration-150">Registrarse</button>
                    </form>
                </section>
            </main>
        </>
